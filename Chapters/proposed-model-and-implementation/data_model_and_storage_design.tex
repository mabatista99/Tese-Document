...
Each row holds a single data point and since telemetry values can be numbers, booleans, or strings, the table uses three nullable columns, one for each data type. Only the column matching the value's type is filled in, and the other two stay null.
